...
# Install skills
mkdir -p "$SKILLS_DIR/pge" "$SKILLS_DIR/pge-team" "$SKILLS_DIR/pge-perf" "$SKILLS_DIR/pge-design" "$SKILLS_DIR/pge-qa" "$SKILLS_DIR/pge-front" "$SKILLS_DIR/pge-archi" "$SKILLS_DIR/pge-doc"
