...
# Install skills
mkdir -p "$SKILLS_DIR/pge" "$SKILLS_DIR/pge-team" "$SKILLS_DIR/pge-perf" "$SKILLS_DIR/pge-design" "$SKILLS_DIR/pge-qa" "$SKILLS_DIR/pge-front" "$SKILLS_DIR/pge-archi" "$SKILLS_DIR/pge-doc" "$SKILLS_DIR/pge-build"
...
cp "$SCRIPT_DIR/pge-archi/SKILL.md" "$SKILLS_DIR/pge-archi/SKILL.md"
cp "$SCRIPT_DIR/pge-doc/SKILL.md" "$SKILLS_DIR/pge-doc/SKILL.md"
cp "$SCRIPT_DIR/pge-build/SKILL.md" "$SKILLS_DIR/pge-build/SKILL.md"
...
echo "[OK] /pge-archi  → $SKILLS_DIR/pge-archi/SKILL.md"
echo "[OK] /pge-doc    → $SKILLS_DIR/pge-doc/SKILL.md"
echo "[OK] /pge-build  → $SKILLS_DIR/pge-build/SKILL.md"
echo ""
...
echo "  Architecture review:    review architecture /pge-archi"
echo "  Documentation:          update docs /pge-doc"
echo "  Build from spec:        implement login screen /pge-build"
echo ""
